...
class ZegoExpressCopyrightedMusicImp : public IZegoCopyrightedMusic {
  public:
    ...
    void requestSong(ZegoCopyrightedMusicRequestConfig config,
        ...
        _config.vendor_id = (zego_copyrighted_music_vendor_id)config.vendorID;
        ZegoStrncpy(_config.room_id, config.roomID.c_str(), ZEGO_EXPRESS_MAX_ROOMID_LEN);
        ZegoStrncpy(_config.master_id, config.masterID.c_str(), ZEGO_EXPRESS_MAX_USERID_LEN);
